    ...
    <div className="min-h-screen bg-[#f8fbff]">
      ...
      <section className="bg-[#f8fbff] py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-heading text-3xl font-bold text-primary-900 mb-8">Dental Services</h2>
      ...
      <section className="bg-white py-16 border-y border-primary-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-heading text-3xl font-bold text-primary-900 mb-12 text-center">Why Choose Us</h2>
      ...
      <section className="bg-[#eef6ff] py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-heading text-3xl font-bold text-primary-900 mb-8">Our Practice</h2>

        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 md:pt-48 md:pb-24">
          <ErrorBoundary>
            <article>
              ...
              {bodyHtml && (
                <div className="prose prose-lg max-w-none prose-headings:font-heading prose-headings:tracking-tight prose-a:text-primary-500" dangerouslySetInnerHTML={{ __html: bodyHtml }} />
              )}
            </article>
          </ErrorBoundary>
        </main>
